...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, STEPPER_Y_M0_Pin|STEPPER_Y_STEP_Pin|DOUT_6_Pin|DOUT_4_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : STEPPER_Y_NSLEEP_Pin DOUT_6_Pin DOUT_4_Pin */
  GPIO_InitStruct.Pin = STEPPER_Y_NSLEEP_Pin|DOUT_6_Pin|DOUT_4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
