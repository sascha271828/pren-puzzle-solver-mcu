...
void Planner_MoveTo(MotionPlanner_t *self, float x_mm, float y_mm,
                    float feedrate_mm_per_s);

// Non‑blocking start
bool Planner_StartMoveTo(MotionPlanner_t *self, float x_mm, float y_mm,
                         float feedrate_mm_per_s);
