...
#define CONFIG_AXIS_MICRO           4UL        /* Microstepping divisor (1/4) */
                                               /* Options: 1, 2, 4, 16       */
...
#define CONFIG_ROT_MICRO            16UL       /* Microstepping divisor (1/16)*/
                                               /* Options: 1, 2, 4, 16       */
...
#define CONFIG_ROT_MAX_SPEED_MM_S      10UL    /* Cruise speed        [mm/s]  */
#define CONFIG_ROT_ACCEL_MM_S2         20UL    /* Acceleration        [mm/s²] */
...
/* Aliases used by Stepper_Init */
#define CONFIG_AXIS_STEPPER_MICRO  CONFIG_AXIS_MICRO
#define CONFIG_ROT_STEPPER_MICRO   CONFIG_ROT_MICRO
