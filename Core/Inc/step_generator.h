...
bool StepGenerator_IsBusy(void); /*Return true if a block is currently being executed or there are blocks waiting in the queue.*/
void StepGenerator_Abort(void); /* Immediately stop all motion and clear the queue.*/
